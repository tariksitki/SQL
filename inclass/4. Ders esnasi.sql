...
FROM tracks t
LEFT JOIN genres g
on t.GenreId = g.GenreId;  -- left join ile join ayni: null yok
...
VALUES(
		48, "TR", "Happy Hotel", 1, 7, 4500);


		
INSERT INTO vacation_plan
VALUES(
		34, "TR", "Beach Hotel", 1, 7, round(4500.4567, 2));
		
		

INSERT INTO vacation_plan(place_id, country, hotel_name, employee_id)
VALUES(35, "TR", "benotel", 123);
...
/* Employees tablosundaki EmployeeId'si 1 olan kişi için bir tatil planı giriniz.*/
	...
	INSERT INTO vacation_plan2 VALUES(2, 34,'TR','HAPPY HOTEL',1,5,5660);
	INSERT INTO vacation_plan2 VALUES(3, 34,'TR','HAPPY HOTEL',1,5,5660);
...
WHERE employee_id = 1;
  ...
  /* people tablosunda salary sutunu 5000 'den büyük olanların salary(maaşına)
